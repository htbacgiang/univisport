                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 gap-4">
                    <div>
                      <input
                        ...
                        aria-required="true"
                        className={`w-full p-4 bg-white/10 backdrop-blur-sm text-white placeholder-blue-100 rounded-xl border-2 border-white/20 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-white/50 transition-all duration-200 ${
                          errors.name ? "border-red-300 bg-red-500/20" : "hover:border-white/30"
                        }`}
                      />
                      {errors.name && (
                    ...
                    <div>
                      <input
                        ...
                        aria-required="true"
                        className={`w-full p-4 bg-white/10 backdrop-blur-sm text-white placeholder-blue-100 rounded-xl border-2 border-white/20 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-white/50 transition-all duration-200 ${
                          errors.phone ? "border-red-300 bg-red-500/20" : "hover:border-white/30"
                        }`}
                      />
                      {errors.phone && (
                        <p className="text-red-300 text-sm mt-2 flex items-center">
                  ...
                  <div>
                    <textarea
                      ...
                      rows={4}
                      className={`w-full p-4 bg-white/10 backdrop-blur-sm text-white placeholder-blue-100 rounded-xl border-2 border-white/20 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-white/50 transition-all duration-200 resize-none ${
                        errors.message ? "border-red-300 bg-red-500/20" : "hover:border-white/30"
                      }`}
                    />
                    {errors.message && (
                      <p className="text-red-300 text-sm mt-2 flex items-center">
