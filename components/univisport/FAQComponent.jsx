      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-12">
          <h2 className="md:text-2xl text-xl uppercase font-bold md:mb-4 mb-2 gradient-faq-title mx-auto">
            Câu Hỏi Thường Gặp về Univi Sport
          </h2>
                ...
                >
                  <div className="flex items-center justify-between">
                    <h3 className={`font-semibold text-sm lg:text-base transition-colors duration-300 ${
                      selectedMedia === index ? "text-[#105d97]" : "text-slate-700"
                    }`}>
                      {faq.question}
                    </h3>
                    <ChevronDown className={`w-4 h-4 lg:w-5 lg:h-5 transition-all duration-300 flex-shrink-0 ml-2 ${
