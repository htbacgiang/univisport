    ...
    return (
        <article className="max-w-none ">
            ...
            <div className="text-center mb-8">
                <h2 className="md:text-2xl text-xl font-bold text-[#105d97] mb-2 mt-4 uppercase">
                   II. Định hướng <span style={{color: '#105d97'}}>phát triển</span> và mục tiêu
                </h2>
            ...
            <div className="mb-12 px-4">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-gradient-to-br from-white to-blue-50/50 rounded-2xl p-6 shadow-lg border border-blue-100/50 hover:shadow-xl transition-all duration-300">
                            <div className="text-center mb-8">
                                ...
                                {[
                                    ...
                                    return (
                                        <div key={index} className="group text-center">
                                            <div className="bg-white rounded-xl p-2 border border-gray-100 hover:border-blue-200 transition-all duration-300 hover:shadow-md hover:scale-105">
                        ...
                        <div className="bg-gradient-to-br from-white to-blue-50/50 rounded-2xl p-8 shadow-lg border border-blue-100/50 hover:shadow-xl transition-all duration-300">
                            <div className="text-center mb-8">
                                ...
                                <h3 className="md:text-2xl text-xl font-bold text-[#105d97] uppercase mb-2" style={{color: '#105d97'}}>
                                    HỆ SINH THÁI UNIVI
                                </h3>
            ...
            <div className="max-w-7xl mx-auto mb-4">
                <div className="bg-white rounded-3xl p-8 md:p-12">
                    ...
                    <div className="text-center mb-6">
                        <h3 className="md:text-2xl text-xl font-bold text-[#105d97] uppercase mb-4" style={{color: '#105d97'}}>
            ...
            <div className="max-w-6xl mx-auto mb-8">
                <div className="bg-white rounded-2xl px-5 md:px-12">
                    {/* Main Content */}
                    <div className="space-y-6">
                        <p className="text-lg text-gray-700 leading-relaxed">
            ...
            <div className="max-w-6xl mx-auto mb-16">
                <div className="bg-white rounded-2xl p-8  px-5 md:px-12">
                    {/* Header */}
            ...
            <div className="max-w-6xl mx-auto mb-20 px-5">
            ...
            <div className="max-w-6xl mx-auto mb-20">
                <div className="bg-white ">
                    ...
                    {/* Commitments Grid */}
                    <div className="space-y-8 px-5 md:px-12">
                        {/* Commitment 1 */}
                        <div className="bg-gray-50 rounded-xl p-6">
                            <div className="flex items-start space-x-4">
                                <div className="flex-shrink-0">
