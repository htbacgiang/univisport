            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 py-8">
                ...
                <article className="bg-white rounded-lg p-6 mb-8 shadow-sm">
                    ...
                    <div className="space-y-4">
                        ...
                        <p>
                            Khác biệt hoàn toàn với quần áo thông thường, <span className="font-semibold">đồng phục Gym chuyên dụng</span> được thiết kế và sản xuất với những tính năng ưu việt. Đầu tư vào đồ tập Gym chất lượng mang lại nhiều lợi ích không ngờ:
                        </p>
                    </div>

                    <div className="grid gap-4 mt-6">
                        <div className="bg-gray-50 rounded-lg p-4">
                            <h3 className="text-xl font-semibold mb-3">Tối ưu sự thoải mái & linh hoạt</h3>
                            <p>Chất liệu co giãn 4 chiều, thiết kế thông minh giúp bạn tự do thực hiện mọi động tác, từ những bài tập tạ nặng đến các chuỗi cardio cường độ cao hay những tư thế yoga phức tạp.</p>
                        </div>

                        <div className="bg-gray-50 rounded-lg p-4">
                            <h3 className="text-xl font-semibold mb-3">Hỗ trợ vận động hiệu quả</h3>
                            <p>Trang phục chuyên dụng có thể tạo lực nén nhẹ lên cơ bắp, cải thiện lưu thông máu, giảm tích tụ axit lactic, từ đó hạn chế mệt mỏi, đau nhức và nguy cơ chuột rút. Đường may phẳng, tinh tế cũng giảm ma sát, giúp bạn tập trung hoàn toàn vào bài tập.</p>
                        </div>

                        <div className="bg-gray-50 rounded-lg p-4">
                            <h3 className="text-xl font-semibold mb-3">Khả năng thấm hút mồ hôi & thoáng khí vượt trội</h3>
                            <p>Giữ cho cơ thể luôn khô ráo, thoáng mát ngay cả khi bạn &quot;đốt cháy&quot; calo hết mình. Điều này không chỉ tạo cảm giác dễ chịu mà còn ngăn ngừa sự phát triển của vi khuẩn gây mùi.</p>
                        </div>

                        <div className="bg-gray-50 rounded-lg p-4">
                            <h3 className="text-xl font-semibold mb-3">Đảm bảo an toàn, phòng tránh chấn thương</h3>
                            <p>Trang phục phù hợp giúp bảo vệ cơ thể, giảm thiểu nguy cơ trầy xước hay các chấn thương không đáng có do quần áo vướng víu hoặc không đủ độ co giãn.</p>
                        </div>

                        <div className="bg-gray-50 rounded-lg p-4">
                            <h3 className="text-xl font-semibold mb-3">Tăng sự tự tin & động lực tập luyện</h3>
                            <p>Khoác lên mình bộ đồ tập vừa vặn, thời trang và chuyên nghiệp chắc chắn sẽ giúp bạn cảm thấy tự tin hơn, có thêm động lực để chinh phục những mục tiêu sức khỏe của mình.</p>
                        </div>

                        <div className="bg-gray-50 rounded-lg p-4">
                            <h3 className="text-xl font-semibold mb-3">Thể hiện phong cách và sự chuyên nghiệp</h3>
                            <p>Đặc biệt đối với Huấn luyện viên cá nhân (PT) và nhân viên phòng Gym, đồng phục chỉn chu, mang dấu ấn thương hiệu sẽ tạo dựng hình ảnh chuyên nghiệp và đáng tin cậy trong mắt khách hàng.</p>
                        </div>
                    </div>
                </article>

                <div className="my-8 text-center">
                    <figure className="inline-block rounded-lg overflow-hidden shadow-md max-w-full">
                        <Image
                ...
                <article className="bg-white rounded-lg p-6 mb-4 shadow-sm">
                    ...
                    <div className="space-y-4 mb-6">
                        <p>
                            Thấu hiểu những nhu cầu và mong muốn đó, <span className="font-semibold">Đồng Phục Univi</span> (thuộc Univi Sport) tự hào mang đến các giải pháp đồng phục Gym toàn diện, chất lượng cao, đáp ứng mọi yêu cầu của cá nhân gymer, đội ngũ PT và các chuỗi phòng tập chuyên nghiệp. Với hơn <Link href="/gioi-thieu" className="font-semibold text-blue-600 hover:text-blue-800 underline">8 năm kinh nghiệm</Link> trong lĩnh vực thiết kế và sản xuất đồng phục thể thao cao cấp, Univi đã khẳng định vị thế là đối tác tin cậy của hàng trăm doanh nghiệp, trong đó có những tên tuổi lớn trong ngành thể hình và chăm sóc sức khỏe như <span className="font-semibold"><Link href="/feedback/chuoi-phong-tap-the-one-kickfit" className="text-blue-600 hover:text-blue-800 underline">KickFit Sport</Link>, <Link href="/feedback/chuoi-phong-tap-fitcaree" className="text-blue-600 hover:text-blue-800 underline">Fitcare</Link></span>.
                        </p>
                        <p>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4 mb-6">
                        <h3 className="text-xl font-semibold mb-3">Univi cam kết:</h3>
                        <div className="space-y-3">
                            <div>
                                <span className="font-semibold">Chất lượng sản phẩm đặt lên hàng đầu:</span>
                                <span className="ml-2">Chúng tôi &quot;không tính phí nếu sản phẩm không đạt chuẩn&quot;.</span>
                            </div>
                            <div>
                                <span className="font-semibold">An toàn tuyệt đối cho người mặc:</span>
                                <span className="ml-2">Tất cả chất liệu vải đều được kiểm định an toàn với da, không chứa hóa chất độc hại như Formaldehyde hay các amin thơm từ thuốc nhuộm Azo.</span>
                            </div>
                            <div>
                                <span className="font-semibold">Giải pháp &quot;SMART SPORT UNIFORM&quot;:</span>
                ...
                <article className="bg-white rounded-2xl p-6 md:p-8 mb-6 shadow-lg border-t-4 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div className="mb-6">
                        <h3 className="text-xl font-bold mb-4">3.1 Chất liệu vải chuyên dụng – Chìa khóa cho hiệu suất tối đa</h3>
                        <p className="mb-6">
                        ...
                        <div className="grid gap-4">
                            <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                                ...
                                <p>Với đặc tính CẢN NẮNG – CẢN GIÓ – CẢN BỤI – NHANH KHÔ, dòng vải này cực kỳ linh hoạt, phù hợp cho các bài tập cardio cường độ cao, các buổi tập ngoài trời hoặc những ai ưa thích sự khô thoáng tức thì.</p>
                            </div>

                            <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                                <h4 className="font-bold text-lg mb-2">UNIVI – SUPER COOL (Polyamide)</h4>
                                <p>Nổi bật với đặc tính MỀM – MƯỢT – MÁT – MỊN. Đây là lựa chọn hoàn hảo cho các lớp Yoga, Dance, Group X trong phòng Gym, hoặc cho những gymer yêu thích cảm giác nhẹ nhàng, mát lạnh và thoải mái tối đa trên da.</p>
                            </div>

                            <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                                <h4 className="font-bold text-lg mb-2">UNIVI - BLENDED</h4>
                                <p>Sự kết hợp thông minh này mang đến những ưu điểm vượt trội như nhanh khô, mềm mịn, mát, nhẹ, chống tia UV cao hơn, chống nhăn và rất bền màu. Đây là dòng vải đa năng, đáp ứng tốt hầu hết các yêu cầu của trang phục Gym.</p>
                            </div>

                            <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                                <h4 className="font-bold text-lg mb-2">Các chất liệu khác</h4>
                    ...
                    <div className="mb-8">
                        <h3 className="text-xl font-bold mb-4">3.2 Thiết kế thông minh – Tối ưu cho mọi chuyển động</h3>
                        <div className="grid gap-3">
                            <div className="p-4 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
                                <span className="font-semibold">Form dáng đa dạng, khoa học:</span>
                                <span className="ml-2">Univi cung cấp nhiều lựa chọn form dáng từ Compression (ôm sát) giúp hỗ trợ cơ bắp, tăng cường lưu thông máu, đến Fitted (ôm vừa) tôn dáng mà vẫn thoải mái, hay Loose fit (rộng rãi) mang lại sự tự do tối đa cho người mặc.</span>
                            </div>
                            <div className="p-4 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
                                <span className="font-semibold">Đường may phẳng (Flatlock seams):</span>
                                <span className="ml-2">Kỹ thuật may tiên tiến này giúp giảm thiểu tối đa sự cọ xát lên da, tránh gây ngứa hay kích ứng, đặc biệt quan trọng khi vận động cường độ cao. Univi chú trọng &quot;may thật kỹ lưỡng cả hai mặt để sản phẩm không chỉ đẹp mà còn bền&quot;.</span>
                            </div>
                            <div className="p-4 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
                                <span className="font-semibold">Kiểu dáng thời trang, năng động:</span>
                                <span className="ml-2">Các thiết kế của Univi luôn cập nhật xu hướng mới nhất, giúp người mặc không chỉ thoải mái khi tập luyện mà còn tự tin thể hiện phong cách cá nhân.</span>
                            </div>
                        </div>
                    </div>

                    <div className="mb-8">
                        <h3 className="text-xl font-bold mb-4">3.3 Công nghệ sản xuất hiện đại – Độ bền vượt trội</h3>
                        <div className="grid gap-3">
                            <div className="p-4 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
                                <span className="font-semibold">Kỹ thuật may tiên tiến:</span>
                                <span className="ml-2">Sử dụng chỉ may chuyên dụng đảm bảo độ bền cho sản phẩm ngay cả khi đối mặt với những bài tập nặng và tần suất giặt giũ thường xuyên.</span>
                            </div>
                            <div className="p-4 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
                                <span className="font-semibold">Công nghệ in thêu cao cấp:</span>
                                <span className="ml-2">Công nghệ in, thêu logo, tên, họa tiết sắc nét, bền màu, không bong tróc, đảm bảo tính thẩm mỹ và sự chuyên nghiệp cho đồng phục, đặc biệt quan trọng cho đồng phục PT và nhân viên phòng Gym.</span>
                            </div>
                        </div>
                    </div>

                    <div className="bg-gradient-to-r from-[#105d97]/5 to-blue-50 rounded-xl p-6">
                        <h3 className="text-xl font-bold mb-4">3.4 Giải pháp tùy chỉnh theo yêu cầu – Khẳng định dấu ấn thương hiệu</h3>
                        <p className="mb-4">
                            <span className="font-bold">Univi mang đến</span> dịch vụ thiết kế và tùy chỉnh đồng phục Gym theo yêu cầu riêng:
                        </p>
                        <div className="grid md:grid-cols-2 gap-4">
                            <div className="bg-white rounded-lg p-4 shadow-sm">
                                <h4 className="font-bold mb-2">Cho cá nhân</h4>
                                <p>Tự do lựa chọn màu sắc, kiểu dáng, họa tiết yêu thích.</p>
                            </div>
                            <div className="bg-white rounded-lg p-4 shadow-sm">
                                <h4 className="font-bold mb-2">Cho đội nhóm PT, Câu lạc bộ</h4>
                                <p>Đồng bộ hóa trang phục theo màu sắc nhận diện thương hiệu, in/thêu logo, slogan, tạo nên hình ảnh chuyên nghiệp, thống nhất và nâng cao giá trị thương hiệu.</p>
                            </div>
                        </div>
                    </div>
                </article>
                ...
                <article className="bg-white rounded-2xl p-6 md:p-8 mb-4 shadow-lg border-t-4 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <p className="text-lg mb-4">
                        <span className="font-bold">Đầu tư vào đồng phục Gym Univi</span> là đầu tư cho sức khỏe, hiệu suất và hình ảnh của bạn:
                    </p>

                    <div className="grid gap-4">
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-lg mb-2">Tối đa hóa hiệu suất tập luyện</h3>
                            <p>Trang phục phù hợp giúp bạn tập trung, thoải mái và phát huy tối đa tiềm năng.</p>
                        </div>

                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-lg mb-2">Mang lại sự thoải mái & tự tin tuyệt đối</h3>
                            <p>Cảm giác dễ chịu từ chất liệu cao cấp và thiết kế thông minh giúp bạn tự tin trong mọi bài tập.</p>
                        </div>

                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-lg mb-2">Xây dựng hình ảnh cá nhân và thương hiệu chuyên nghiệp</h3>
                            <p>Một bộ đồng phục chỉn chu, chất lượng là tuyên ngôn về sự nghiêm túc và chuyên nghiệp của bạn hoặc thương hiệu phòng Gym của bạn.</p>
                        </div>

                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-lg mb-2">Độ bền cao, tiết kiệm chi phí dài hạn</h3>
                            <p>Sản phẩm Univi được làm từ chất liệu bền bỉ, giúp bạn tiết kiệm chi phí thay mới đồng phục thường xuyên.</p>
                        </div>

                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-lg mb-2">Bảo vệ sức khỏe người mặc</h3>
                            <p>Với cam kết về chất liệu an toàn, bạn hoàn toàn yên tâm khi sử dụng sản phẩm của Univi.</p>
                        </div>
                    </div>
                </article>
                ...
                <article className="bg-white rounded-2xl p-6 md:p-8 mb-8 shadow-lg border-t-4 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <p className="text-lg mb-3">
                        <span className="font-bold">Univi Sport</span> cung cấp một danh mục sản phẩm đồng phục Gym phong phú, đáp ứng mọi nhu cầu và sở thích:
                    </p>
                    <h3 className="text-xl font-bold mb-4">5.1 Đồng phục Gym dành cho Nam:</h3>
                ...
                <article className="bg-white rounded-2xl p-6 md:p-8 mb-8 shadow-lg border-t-4 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    <h3 className="text-xl font-bold mb-4">5.2 Đồng phục Gym dành cho Nữ:</h3>
                    <ul className="grid gap-4 mb-4">
                        <li className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                ...
                <article className="bg-white rounded-2xl p-6 md:p-8 mb-8 shadow-lg border-t-4 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    <h3 className="text-xl font-bold mb-4">5.3 Đồng phục Gym cho Huấn luyện viên (PT) và Nhân viên phòng Gym:</h3>
                    <ul className="grid gap-4 mb-4">
                        <li className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                ...
                <article className="bg-white rounded-2xl p-6 md:p-8 mb-8 shadow-lg border-t-4 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <p className="text-lg mb-3">
                        <span className="font-bold">Univi cam kết</span> mang đến trải nghiệm đặt hàng thuận tiện và chuyên nghiệp nhất:
                    </p>
                    <ol className="grid gap-4 mb-8">
                        <li className="bg-white rounded-xl p-6 shadow-lg border border-slate-200 hover:shadow-xl transition-all">
                ...
                <article className="bg-white rounded-2xl p-6 md:p-8 mb-8 shadow-lg border-t-4 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    <p className="text-lg mb-3">
                        <span className="font-bold">Univi</span> không chỉ đơn thuần là nhà cung cấp đồng phục, chúng tôi mong muốn trở thành đối tác chiến lược, mang đến <span className="font-semibold">&quot;GIẢI PHÁP SMART SPORT UNIFORM CHO CÁC CHUỖI PHÒNG TẬP&quot;</span>. Chúng tôi giúp các phòng Gym nâng cao hình ảnh thương hiệu, tạo sự khác biệt và mang đến trải nghiệm tốt nhất cho hội viên thông qua những bộ đồng phục chất lượng, được thiết kế riêng.
                    </p>
                    <p className="text-lg mb-3">
                        Với kinh nghiệm hợp tác cùng các đơn vị thể thao uy tín như <span className="font-semibold"><Link href="/feedback/chuoi-phong-tap-the-one-kickfit" className="text-blue-600 hover:text-blue-800 underline">KickFit Sport</Link>, <Link href="/feedback/chuoi-phong-tap-fitcaree" className="text-blue-600 hover:text-blue-800 underline">Fitcare</Link></span>, Univi hiểu rõ những thách thức và cơ hội trong ngành. Chúng tôi cam kết mang lại những sản phẩm đồng phục Gym không chỉ đẹp về mẫu mã, vượt trội về chất lượng mà còn có mức giá hợp lý, <span className="font-bold">&quot;chỉ từ 99.000 đ cho các sản phẩm trung cao cấp&quot;</span>, tạo ra giá trị thực sự cho mọi khách hàng.
                    </p>
                </article>
                <div className="my-12 text-center">
                    <figure className="inline-block rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all hover:scale-105 relative group">
                    ...
                    <div>
                        <div className="text-center mb-8">
                            ...
                            <p className="text-base text-white max-w-4xl mx-auto mb-4">
                                Đã đến lúc nâng cấp trải nghiệm tập luyện của bạn và đội ngũ với những bộ đồng phục Gym đẳng cấp từ <span className="font-bold">Univi Sport</span>! Đừng để trang phục kém chất lượng cản trở hành trình chinh phục mục tiêu sức khỏe và vóc dáng của bạn.
                            </p>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                            ...
                            <div className="bg-white/10 rounded-lg p-4">
                                ...
                                <div>D14, 180 Thanh Bình, Hà Đông</div>
                            </div>
                        </div>
