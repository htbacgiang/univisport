    ...
    <div className="min-h-screen bg-gray-50">
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-6">
            ...
            <article className="bg-white rounded-2xl p-4 md:p-6 mb-6 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                ...
                <p className="text-base mb-3">
                    <span className="font-semibold">Tại Univi Sport</span>, chúng tôi không chỉ tạo ra những bộ đồng phục MMA, chúng tôi kiến tạo những người bạn đồng hành đáng tin cậy trên mỗi trận chiến bạn chinh phục. Chúng tôi tin rằng, một bộ trang phục tốt sẽ góp phần không nhỏ vào thành công và niềm vui của mỗi võ sĩ.
                </p>
                <p className="text-base mb-3">
