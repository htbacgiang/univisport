                ...
                <article className="bg-white rounded-lg p-6 mb-8 shadow-sm">
                    ...
                    <div className="grid gap-4">
                        <div className="bg-gray-50 rounded-lg p-4">
                            ...
                            <p>Univi Sport không ngừng nghiên cứu chuyên sâu về chất liệu để tìm ra những loại vải tốt nhất, phù hợp nhất với từng bộ môn, bao gồm cả Pickleball. Chúng tôi hiểu rõ những vận động đặc thù và yêu cầu về trang phục của môn thể thao này.</p>
                        </div>
                    ...
                    <div>
                        <div className="text-center mb-8">
                            ...
                            <p className="text-base text-white max-w-4xl mx-auto mb-4">
                                Đã đến lúc nâng cấp trải nghiệm thi đấu Pickleball của bạn và đội nhóm với những bộ đồng phục đẳng cấp từ <span className="font-bold">Univi Sport</span>! Đừng để trang phục kém chất lượng cản trở hành trình chinh phục mọi thử thách trên sân Pickleball.
                            </p>
