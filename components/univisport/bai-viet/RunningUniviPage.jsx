    ...
    <div className="min-h-screen bg-gray-50">
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-6">
            ...
            <article className="bg-white rounded-2xl p-4 md:p-6 mb-6 shadow-lg  hover:shadow-xl transition-all hover:-translate-y-1">
                ...
                <p className="text-base mb-3">
                    <span className="font-semibold">Univi Sport</span> cung cấp một danh mục sản phẩm đồng phục chạy bộ phong phú, đáp ứng mọi nhu cầu và sở thích:
                </p>
                <h3 className="text-xl font-bold mb-2">
            ...
            <article className="bg-white rounded-2xl p-4 md:p-6 mb-6 shadow-lg  hover:shadow-xl transition-all hover:-translate-y-1">
                ...
                <p className="text-base mb-3">
                    <span className="font-semibold">Tại Univi Sport</span>, chúng tôi không chỉ tạo ra những bộ đồng phục chạy bộ, chúng tôi kiến tạo những người bạn đồng hành đáng tin cậy trên mỗi kilomet bạn chinh phục. Chúng tôi tin rằng, một bộ trang phục tốt sẽ góp phần không nhỏ vào thành công và niềm vui của mỗi runner.
                </p>
                <p className="text-base mb-3">
