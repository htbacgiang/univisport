        ...
        <div className="container mx-auto px-6 py-12">
          ...
          <div className="block md:hidden">
            ...
            <div className="mb-8">
              <div className="mb-6">
                ...
                <div className="flex space-x-4">
                  ...
                  <Link href="/" className="w-10 h-10 bg-pink-600 rounded-lg flex items-center justify-center hover:shadow-lg hover:shadow-pink-500 transition-all duration-300 hover:scale-110">
                    <FaInstagram className="text-white" />
                  </Link>
                  <Link href="/" className="w-10 h-10 bg-red-600 rounded-lg flex items-center justify-center hover:shadow-lg hover:shadow-red-500 transition-all duration-300 hover:scale-110">
            ...
            <div className="space-y-6">
              ...
              {/* Hàng 3: Đồng phục doanh nghiệp - Full width */}
              <div>
                <p className="text-base font-semibold text-white mb-4 relative">
                  Đồng phục doanh nghiệp
                  <div className="absolute -bottom-2 left-0 w-6 h-0.5 bg-purple-500"></div>
                </p>
                <ul className="space-y-2">
                  {[
