      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            // Video ngoài viewport - dừng video
            video.pause();
          }
        });
      },
      {
        threshold: 0.5, // Phát video khi 50% video hiển thị trong viewport
      }
    );
  ...
  return (
    <DefaultLayout>
      ...
      <div className="relative w-full h-[30vh] md:h-[70vh] overflow-hidden bg-gray-900">
        ...
        <div className="absolute inset-0 pointer-events-none" style={{background: `linear-gradient(135deg, rgba(16, 93, 151, 0.4) 0%, rgba(16, 93, 151, 0.2) 50%, transparent 100%)`}} />
        ...
        <button
          onClick={toggleMute}
          className="absolute bottom-4 right-4 z-10 bg-white/90 hover:bg-white rounded-full p-2 shadow-md border border-white/60 transition-colors"
          aria-label={isMuted ? "Bật âm thanh" : "Tắt âm thanh"}
        >
          {isMuted ? (
            <VolumeX className="w-5 h-5" style={{ color: '#105d97' }} />
          ) : (
            <Volume2 className="w-5 h-5" style={{ color: '#105d97' }} />
          )}
        </button>
      ...
      <section className="py-8 relative overflow-hidden">
        ...
        <div className="container mx-auto px-3 md:px-12 relative z-10">
          ...
          <div className="">
            ...
            <div className="bg-gradient-to-r from-gray-50 to-white rounded-2xl py-8 ">
              <PartnersSection />
            </div>
          </div>
        </div>
      ...
      <section className="py-8" style={{background: 'linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%)'}}>
        <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="text-center mb-8">
            <h2 className="md:text-2xl text-xl font-bold text-[#105d97] uppercase mb-4 ">
              ...
              <div className="lg:col-span-2">
                <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100 h-full">
                  <div className="space-y-6">
                    <h3 className="md:text-2xl text-xl font-bold text-[#105d97] mb-4" style={{color: '#105d97'}}>
                      VỀ UNIVI
                    </h3>
          ...
          <div className=" mx-auto">
            <div className="text-center mb-6">
              ...
              <p className="text-base text-gray-600 max-w-4xl mx-auto mt-3">
