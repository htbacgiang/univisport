...
const DongPhucGym = ({ initialProducts }) => {
  ...
  const structuredData = {
    ...
    "@type": "CollectionPage",
    "name": `Đồng phục MMA - Đồng phục Univi`,
    "description": `Khám phá bộ sưu tập đồng phục MMA chất lượng cao từ Đồng phục Univi, thiết kế chuyên nghiệp, bền bỉ và phù hợp cho mọi hoạt động võ thuật.`,
    ...
    <DefaultLayout2>
      ...
      <div className="relative w-full min-h-[300px] overflow-hidden">
        <Image
          ...
          alt={`Đồng phục MMA Đồng phục Univi - Bộ sưu tập võ thuật chuyên nghiệp chất lượng cao`}
          fill
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="relative bg-white rounded-xl p-1 shadow-lg border border-gray-100">
                        <input
                          type="text"
                          placeholder="Tìm kiếm đồng phục MMA..."
                          value={searchQuery}
...
export async function getServerSideProps() {
  try {
    ...
    const initialProducts = await getProductsByCategory('dong-phuc-mma');
    ...
    return {
      props: {
        ...
        meta: {
          title: "Đồng phục MMA - Đồng phục Univi",
          description: "Bước vào sàn đấu MMA với sự tự tin tuyệt đối cùng đồng phục chuyên nghiệp từ Đồng Phục Univi! Sản phẩm quần short và áo rashguard MMA của chúng tôi được chế tạo từ vật liệu cao cấp, siêu bền, chống rách và co giãn đa chiều, cho phép bạn thực hiện mọi kỹ thuật grappling và striking một cách tự do.",
          keywords: "đồng phục MMA, Đồng phục Univi",
          author: "Đồng phục Univi",
