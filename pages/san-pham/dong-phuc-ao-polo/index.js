...
const DongPhucGym = ({ initialProducts }) => {
  ...
  const structuredData = {
    ...
    "@type": "CollectionPage",
    "name": `Đồng phục áo Polo - Đồng phục Univi`,
    "description": `Khám phá bộ sưu tập đồng phục áo Polo chất lượng cao từ Đồng phục Univi, thiết kế thanh lịch, chuyên nghiệp và phù hợp cho mọi hoạt động công sở và thể thao.`,
    ...
    <DefaultLayout2>
      ...
      <div className="relative w-full min-h-[300px] overflow-hidden">
        <Image
          ...
          alt={`Đồng phục áo Polo Đồng phục Univi - Bộ sưu tập công sở chuyên nghiệp chất lượng cao`}
          fill
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="relative bg-white rounded-xl p-1 shadow-lg border border-gray-100">
                        <input
                          type="text"
                          placeholder="Tìm kiếm đồng phục áo polo..."
                          value={searchQuery}
...
export async function getServerSideProps() {
  try {
    ...
    const initialProducts = await getProductsByCategory('dong-phuc-ao-polo');

    const meta = {
      title: "Đồng phục áo Polo - Đồng phục Univi",
      description: "Khám phá bộ sưu tập đồng phục áo Polo chất lượng cao từ Đồng phục Univi! Sản phẩm áo polo của chúng tôi được thiết kế thanh lịch, chuyên nghiệp với chất liệu cao cấp, phù hợp cho mọi hoạt động công sở và thể thao.",
      keywords: "đồng phục áo polo, Đồng phục Univi, áo polo công sở, đồng phục chuyên nghiệp, áo polo thể thao, đồng phục doanh nghiệp",
      ...
      og: {
        ...
        description: "Khám phá bộ sưu tập đồng phục áo Polo chất lượng cao từ Đồng phục Univi! Sản phẩm áo polo của chúng tôi được thiết kế thanh lịch, chuyên nghiệp với chất liệu cao cấp, phù hợp cho mọi hoạt động công sở và thể thao.",
        type: "website",
        image: "https://dongphucunivi.com/images/dong-phuc-ao-polo.jpg",
        imageWidth: "1200",
        imageHeight: "630",
        url: "https://dongphucunivi.com/san-pham/dong-phuc-ao-polo",
    ...
    return {
      props: {
        ...
        meta: {
          title: "Đồng phục áo Polo - Đồng phục Univi",
          description: "Khám phá bộ sưu tập đồng phục áo Polo chất lượng cao từ Đồng phục Univi! Sản phẩm áo polo của chúng tôi được thiết kế thanh lịch, chuyên nghiệp với chất liệu cao cấp, phù hợp cho mọi hoạt động công sở và thể thao.",
          keywords: "đồng phục áo polo, Đồng phục Univi",
          author: "Đồng phục Univi",
