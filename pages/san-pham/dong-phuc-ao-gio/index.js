...
const DongPhucAogo = ({ initialProducts }) => {
  const categorySlug = 'dong-phuc-ao-gio';
  ...
  const handleSort = (e) => {
    ...
    if (option === 'price-asc') {
      ...
      sortedProducts.sort((a, b) => (b.maxPrice || b.price) - (a.maxPrice || a.price));
    }
  ...
  const structuredData = {
    ...
    "@type": "CollectionPage",
    "name": `Đồng phục Áo gió - Đồng phục Univi`,
    "description": `Khám phá bộ sưu tập đồng phục áo gió công nghệ cao từ Đồng phục Univi, cản gió – chống nắng, giải pháp tối ưu cho hoạt động ngoài trời.`,
    "url": "https://dongphucunivi.com/san-pham/dong-phuc-ao-gio",
    "breadcrumb": {
      "@type": "BreadcrumbList",
      "itemListElement": [
        {
        ...
        },
        {
          ...
          "item": "https://dongphucunivi.com/san-pham/dong-phuc-ao-gio"
        }
      ]
    },
    "mainEntity": {
      ...
      <div className="relative w-full min-h-[300px] overflow-hidden">
        <Image
          src="/images/banner-univi.png"
            alt={`Đồng phục Áo gió Đồng phục Univi - Bộ sưu tập áo gió công nghệ chất lượng cao`}
          fill
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <main className="w-full lg:w-4/5">
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="relative bg-white rounded-xl p-1 shadow-lg border border-gray-100">
                        <input
                          type="text"
                          placeholder="Tìm kiếm đồng phục áo gió..."
                          value={searchQuery}
            ...
            {currentProducts.length > 0 ? (
              <section className="grid gap-6 grid-cols-2 sm:grid-cols-2 lg:grid-cols-4" aria-label="Danh sách sản phẩm đồng phục áo gió">
...
export default DongPhucAogo;

export async function getServerSideProps() {
  try {
    // Get products from API
    const initialProducts = await getProductsByCategory('dong-phuc-ao-gio');
