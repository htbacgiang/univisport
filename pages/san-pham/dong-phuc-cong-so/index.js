...
const DongPhucGym = ({ initialProducts }) => {
  ...
  const structuredData = {
    ...
    "@type": "CollectionPage",
    "name": `Đồng phục công sở - Đồng phục Univi`,
    "description": `Khám phá bộ sưu tập đồng phục công sở chuyên nghiệp từ Đồng phục Univi, thiết kế tinh tế, lịch sự và phù hợp cho môi trường làm việc hiện đại.`,
    ...
    <DefaultLayout2>
      ...
      <div className="relative w-full min-h-[300px] overflow-hidden">
        <Image
          ...
          alt={`Đồng phục công sở Đồng phục Univi - Bộ sưu tập chuyên nghiệp chất lượng cao`}
          fill
          ...
          <div className="px-6 md:px-10 lg:px-16 pb-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-lg text-gray-200 max-w-4xl">
                ...
                thiết kế tinh tế và chuyên nghiệp.
              </p>
            </div>
          </div>
        </div>
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="relative bg-white rounded-xl p-1 shadow-lg border border-gray-100">
                        <input
                          type="text"
                          placeholder="Tìm kiếm đồng phục công sở..."
                          value={searchQuery}
...
export async function getServerSideProps() {
  try {
    ...
    const initialProducts = await getProductsByCategory('dong-phuc-cong-so');

    const meta = {
      title: "Đồng phục công sở - Đồng phục Univi",
      description: "Khám phá bộ sưu tập đồng phục công sở chuyên nghiệp từ Đồng phục Univi! Sản phẩm đồng phục công sở của chúng tôi được thiết kế tinh tế, lịch sự với chất liệu cao cấp, phù hợp cho môi trường làm việc hiện đại và chuyên nghiệp.",
      keywords: "đồng phục công sở, Đồng phục Univi, đồng phục doanh nghiệp, đồng phục văn phòng, đồng phục chuyên nghiệp, đồng phục công ty",
      ...
      og: {
        ...
        description: "Khám phá bộ sưu tập đồng phục công sở chuyên nghiệp từ Đồng phục Univi! Sản phẩm đồng phục công sở của chúng tôi được thiết kế tinh tế, lịch sự với chất liệu cao cấp, phù hợp cho môi trường làm việc hiện đại và chuyên nghiệp.",
        type: "website",
        image: "https://dongphucunivi.com/images/dong-phuc-cong-so.jpg",
        imageWidth: "1200",
        imageHeight: "630",
        url: "https://dongphucunivi.com/san-pham/dong-phuc-cong-so",
    ...
    return {
      props: {
        ...
        meta: {
          title: "Đồng phục công sở - Đồng phục Univi",
          description: "Khám phá bộ sưu tập đồng phục công sở chuyên nghiệp từ Đồng phục Univi! Sản phẩm đồng phục công sở của chúng tôi được thiết kế tinh tế, lịch sự với chất liệu cao cấp, phù hợp cho môi trường làm việc hiện đại và chuyên nghiệp.",
          keywords: "đồng phục công sở, Đồng phục Univi",
          author: "Đồng phục Univi",
