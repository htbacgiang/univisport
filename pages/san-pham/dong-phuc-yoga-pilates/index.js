...
const DongPhucGym = ({ initialProducts }) => {
  ...
  const structuredData = {
    ...
    "@type": "CollectionPage",
    "name": `Đồng phục Yoga - Pilates - Đồng phục Univi`,
    "description": `Khám phá bộ sưu tập đồng phục Yoga - Pilates chất lượng cao từ Đồng phục Univi, thiết kế hiện đại, thoải mái và phù hợp cho mọi hoạt động thể thao.`,
    ...
    "breadcrumb": {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Đồng phục Yoga - Pilates", "item": "https://dongphucunivi.com/san-pham/dong-phuc-yoga-pilates" }
      ]
    },
    "mainEntity": {
      "@type": "ItemList",
    ...
    <DefaultLayout2>
      ...
      <div className="relative w-full min-h-[300px] overflow-hidden">
        <Image
          ...
          alt={`Đồng phục Yoga - Pilates Đồng phục Univi - Bộ sưu tập thể thao chất lượng cao`}
          fill
          ...
          <div className="px-6 md:px-10 lg:px-16 pb-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-lg text-gray-200 max-w-4xl">
                ...
                thiết kế hiện đại và thoải mái.
              </p>
            </div>
          </div>
        </div>
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="relative bg-white rounded-xl p-1 shadow-lg border border-gray-100">
                        <input
                          type="text"
                          placeholder="Tìm kiếm đồng phục yoga - pilates..."
                          value={searchQuery}
...
export async function getServerSideProps() {
  try {
    ...
    const initialProducts = await getProductsByCategory('dong-phuc-yoga-pilates');

    const meta = {
      title: "Đồng phục Yoga - Pilates - Đồng phục Univi",
      description: "Đồng phục Yoga Pilates Univi: Chất liệu UNIVI-SUPER COOL mềm mại, mát lạnh, co giãn tối đa. Thiết kế chuyên dụng, an toàn cho da, giúp bạn tự tin chinh phục mọi asana. Nâng cao trải nghiệm tập luyện cùng Univi!",
