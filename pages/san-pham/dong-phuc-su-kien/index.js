...
const DongPhucGym = ({ initialProducts }) => {
  ...
  const structuredData = {
    ...
    "@type": "CollectionPage",
    "name": `Đồng phục Sự kiện - Đồng phục Univi`,
    "description": `Khám phá bộ sưu tập đồng phục sự kiện chuyên nghiệp từ Đồng phục Univi, thiết kế sang trọng, lịch sự và phù hợp cho mọi loại sự kiện quan trọng.`,
    ...
    <DefaultLayout2>
      ...
      <div className="relative w-full min-h-[300px] overflow-hidden">
        <Image
          ...
          alt={`Đồng phục Sự kiện Đồng phục Univi - Bộ sưu tập sự kiện chất lượng cao`}
          fill
          ...
          <div className="px-6 md:px-10 lg:px-16 pb-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-lg text-gray-200 max-w-4xl">
                ...
                thiết kế sang trọng và lịch sự.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <main className="w-full lg:w-4/5">
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="relative bg-white rounded-xl p-1 shadow-lg border border-gray-100">
                        <input
                          type="text"
                          placeholder="Tìm kiếm đồng phục sự kiện..."
                          value={searchQuery}
            ...
            {currentProducts.length > 0 ? (
              <section className="grid gap-6 grid-cols-2 sm:grid-cols-2 lg:grid-cols-4" aria-label="Danh sách sản phẩm đồng phục sự kiện">
...
export async function getServerSideProps() {
  try {
    const response = await fetch(`${process.env.BASE_URL}/api/products?category=dong-phuc-su-kien`);
    if (!response.ok) {
    ...
    const meta = {
      ...
      description: "Khám phá bộ sưu tập đồng phục sự kiện chuyên nghiệp từ Đồng phục Univi! Sản phẩm đồng phục sự kiện của chúng tôi được thiết kế sang trọng, lịch sự với chất liệu cao cấp, phù hợp cho mọi loại sự kiện quan trọng và trang trọng.",
      keywords: "đồng phục sự kiện, Đồng phục Univi, đồng phục trang trọng, đồng phục hội thảo, đồng phục lễ hội, đồng phục doanh nghiệp, đồng phục chính thức",
      ...
      og: {
        ...
        description: "Khám phá bộ sưu tập đồng phục sự kiện chuyên nghiệp từ Đồng phục Univi! Sản phẩm đồng phục sự kiện của chúng tôi được thiết kế sang trọng, lịch sự với chất liệu cao cấp, phù hợp cho mọi loại sự kiện quan trọng và trang trọng.",
        type: "website",
        image: "https://dongphucunivi.com/images/dong-phuc-su-kien.jpg",
        imageWidth: "1200",
        imageHeight: "630",
        url: "https://dongphucunivi.com/san-pham/dong-phuc-su-kien",
    ...
    return {
      props: {
        ...
        meta: {
          title: "Đồng phục Sự kiện - Đồng phục Univi",
          description: "Khám phá bộ sưu tập đồng phục sự kiện chuyên nghiệp từ Đồng phục Univi! Sản phẩm đồng phục sự kiện của chúng tôi được thiết kế sang trọng, lịch sự với chất liệu cao cấp, phù hợp cho mọi loại sự kiện quan trọng và trang trọng.",
          keywords: "đồng phục sự kiện, Đồng phục Univi",
          author: "Đồng phục Univi",
