...
const DongPhucGym = ({ initialProducts }) => {
  ...
  const structuredData = {
    ...
    "@type": "CollectionPage",
    "name": `Đồng phục Lễ tân - Đồng phục Univi`,
    "description": `Khám phá bộ sưu tập đồng phục lễ tân chất lượng cao từ Đồng phục Univi, thiết kế hiện đại, chuyên nghiệp và phù hợp cho mọi ngành nghề.`,
    ...
    <DefaultLayout2>
      ...
      <div className="relative w-full min-h-[300px] overflow-hidden">
        <Image
          ...
          alt={`Đồng phục Lễ tân Đồng phục Univi - Bộ sưu tập chuyên nghiệp chất lượng cao`}
          fill
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="relative bg-white rounded-xl p-1 shadow-lg border border-gray-100">
                        <input
                          type="text"
                          placeholder="Tìm kiếm đồng phục lễ tân..."
                          value={searchQuery}
...
export async function getServerSideProps() {
  try {
    const response = await fetch(`${process.env.BASE_URL}/api/products?category=dong-phuc-le-tan`);
    if (!response.ok) {
    ...
    const meta = {
      ...
      keywords: "đồng phục lễ tân, Đồng phục Univi, quần áo công sở, đồng phục chuyên nghiệp, thiết kế lễ tân, đồng phục chất lượng",
      ...
      og: {
        ...
        description: "Đồng Phục Univi không chỉ may đo đồng phục Lễ tân mà còn tư vấn giải pháp toàn diện phù hợp với từng ngành nghề và đặc thù doanh nghiệp. Từ việc chọn lựa chất liệu vải tối ưu, thiết kế kiểu dáng hiện đại, đến việc tinh chỉnh từng chi tiết theo yêu cầu, chúng tôi cam kết mang đến sự hài lòng và sản phẩm chất lượng vượt trội.",
        type: "website",
        image: "https://dongphucunivi.com/images/dong-phuc-le-tan.jpg",
        imageWidth: "1200",
        imageHeight: "630",
        url: "https://dongphucunivi.com/san-pham/dong-phuc-le-tan",
    ...
    return {
      props: {
        ...
        meta: {
          title: "Đồng phục Lễ tân - Đồng phục Univi",
          description: "Đồng Phục Univi không chỉ may đo đồng phục Lễ tân mà còn tư vấn giải pháp toàn diện phù hợp với từng ngành nghề và đặc thù doanh nghiệp. Từ việc chọn lựa chất liệu vải tối ưu, thiết kế kiểu dáng hiện đại, đến việc tinh chỉnh từng chi tiết theo yêu cầu, chúng tôi cam kết mang đến sự hài lòng và sản phẩm chất lượng vượt trội.",
          keywords: "đồng phục lễ tân, Đồng phục Univi",
          author: "Đồng phục Univi",
