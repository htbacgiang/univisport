...
const DongPhucGym = ({ initialProducts }) => {
  ...
  const structuredData = {
    ...
    "@type": "CollectionPage",
    "name": `Đồng phục Chạy bộ - Đồng phục Univi`,
    "description": `Khám phá bộ sưu tập đồng phục chạy bộ chất lượng cao từ Đồng phục Univi, thiết kế hiện đại, thoải mái và phù hợp cho mọi hoạt động thể thao.`,
    ...
    <DefaultLayout2>
      ...
      <div className="relative w-full min-h-[300px] overflow-hidden">
        <Image
          ...
          alt={`Đồng phục Chạy bộ Đồng phục Univi - Bộ sưu tập thể thao chất lượng cao`}
          fill
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="relative bg-white rounded-xl p-1 shadow-lg border border-gray-100">
                        <input
                          type="text"
                          placeholder="Tìm kiếm đồng phục chạy bộ..."
                          value={searchQuery}
...
export async function getServerSideProps() {
  try {
    ...
    const initialProducts = await getProductsByCategory('dong-phuc-chay-bo');
    ...
    return {
      props: {
        ...
        meta: {
          title: "Đồng phục Chạy bộ - Đồng phục Univi",
          description: "Univi chuyên may đồng phục chạy bộ cho cá nhân & CLB. Chất liệu mềm mại, chống ma sát, thiết kế thoải mái vận động. In logo đội nhóm. Khám phá ngay!",
          keywords: "đồng phục chạy bộ, Đồng phục Univi",
          author: "Đồng phục Univi",
