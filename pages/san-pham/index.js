...
const ProductsPage = ({ relatedPosts }) => {
  ...
  const handleSearch = (e) => {
    ...
    // Search functionality removed - page only shows components
  };

  const handleSort = (e) => {
    const option = e.target.value;
    setSortOption(option);
    // Sort functionality removed - page only shows components
  };
  ...
  return (
    <DefaultLayout2>
      <h1 className="visually-hidden">Đồng Phục Thể Thao Univi: Chuyên Nghiệp, Chất Lượng Cao, Giá Tốt</h1>
