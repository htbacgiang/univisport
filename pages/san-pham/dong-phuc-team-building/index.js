...
const categories = [
  ...
  'Đồng phục Chạy bộ', 'Đồng phục MMA', 'Đồng phục Golf - Tennis',
  'Đồng phục áo Polo', 'Đồng phục công sở', 'Đồng phục Team building', 'Đồng phục Áo gió'
];
...
const DongPhucGym = ({ initialProducts }) => {
  ...
  const structuredData = {
    ...
    "@type": "CollectionPage",
    "name": `Đồng phục Team building - Đồng phục Univi`,
    "description": `Khám phá bộ sưu tập đồng phục team building chuyên nghiệp từ Đồng phục Univi, thiết kế năng động, sáng tạo và phù hợp cho các hoạt động xây dựng đội nhóm.`,
    ...
    <DefaultLayout2>
      ...
      <div className="relative w-full min-h-[300px] overflow-hidden">
        <Image
          ...
          alt={`Đồng phục Team building Đồng phục Univi - Bộ sưu tập xây dựng đội nhóm chất lượng cao`}
          fill
        ...
        <div className="absolute inset-0 flex flex-col justify-end">
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-white">
              ...
              <p className="text-lg text-gray-200 max-w-4xl">
                ...
                thiết kế năng động và sáng tạo.
          </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <main className="w-full lg:w-4/5">
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="relative bg-white rounded-xl p-1 shadow-lg border border-gray-100">
                        <input
                          type="text"
                          placeholder="Tìm kiếm đồng phục team building..."
                          value={searchQuery}
            ...
            {currentProducts.length > 0 ? (
              <section className="grid gap-6 grid-cols-2 sm:grid-cols-2 lg:grid-cols-4" aria-label="Danh sách sản phẩm đồng phục gym">
...
export async function getServerSideProps() {
  try {
    ...
    const initialProducts = await getProductsByCategory('dong-phuc-team-building');

    const meta = {
      title: "Đồng phục Team building - Đồng phục Univi",
      description: "Khám phá bộ sưu tập đồng phục team building chuyên nghiệp từ Đồng phục Univi! Sản phẩm đồng phục team building của chúng tôi được thiết kế năng động, sáng tạo với chất liệu cao cấp, phù hợp cho các hoạt động xây dựng đội nhóm và sự kiện doanh nghiệp.",
      keywords: "đồng phục team building, Đồng phục Univi, đồng phục sự kiện, đồng phục doanh nghiệp, đồng phục hoạt động nhóm, đồng phục công ty",
      ...
      og: {
        ...
        description: "Khám phá bộ sưu tập đồng phục team building chuyên nghiệp từ Đồng phục Univi! Sản phẩm đồng phục team building của chúng tôi được thiết kế năng động, sáng tạo với chất liệu cao cấp, phù hợp cho các hoạt động xây dựng đội nhóm và sự kiện doanh nghiệp.",
        type: "website",
        image: "https://dongphucunivi.com/images/dong-phuc-team-building.jpg",
        imageWidth: "1200",
        imageHeight: "630",
        url: "https://dongphucunivi.com/san-pham/dong-phuc-team-building",
    ...
    return {
      props: {
        ...
        meta: {
          title: "Đồng phục Team building - Đồng phục Univi",
          description: "Khám phá bộ sưu tập đồng phục team building chuyên nghiệp từ Đồng phục Univi! Sản phẩm đồng phục team building của chúng tôi được thiết kế năng động, sáng tạo với chất liệu cao cấp, phù hợp cho các hoạt động xây dựng đội nhóm và sự kiện doanh nghiệp.",
          keywords: "đồng phục team building, Đồng phục Univi",
          author: "Đồng phục Univi",
