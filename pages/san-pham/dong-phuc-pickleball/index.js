...
const DongPhucGym = ({ initialProducts }) => {
  ...
  const structuredData = {
    ...
    "@type": "CollectionPage",
    "name": `Đồng phục Pickleball - Đồng phục Univi`,
    "description": `Khám phá bộ sưu tập đồng phục Pickleball chất lượng cao từ Đồng phục Univi, thiết kế hiện đại, thoải mái và phù hợp cho mọi hoạt động thể thao.`,
    ...
    <DefaultLayout2>
      ...
      <div className="relative w-full min-h-[300px] overflow-hidden">
        <Image
          ...
          alt={`Đồng phục Pickleball Đồng phục Univi - Bộ sưu tập thể thao chất lượng cao`}
          fill
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="relative bg-white rounded-xl p-1 shadow-lg border border-gray-100">
                        <input
                          type="text"
                          placeholder="Tìm kiếm đồng phục pickleball..."
                          value={searchQuery}
...
export async function getServerSideProps() {
  try {
    ...
    const initialProducts = await getProductsByCategory('dong-phuc-pickleball');
    ...
    const meta = {
      ...
      keywords: "đồng phục pickleball, Đồng phục Univi, quần áo thể thao, đồng phục thể thao, thiết kế pickleball, thể thao chất lượng",
      ...
      og: {
        ...
        description: "Trải nghiệm đồng phục Pickleball Univi cao cấp và BST UniPick sành điệu. Chất liệu chuyên dụng, co giãn tối đa, thoáng khí vượt trội cho mọi chuyển động. Univi mang đến sự thoải mái và phong cách cho người chơi Pickleball. Khám phá ngay!",
        type: "website",
        image: "https://dongphucunivi.com/images/dong-phuc-pickleball.jpg",
        imageWidth: "1200",
        imageHeight: "630",
        url: "https://dongphucunivi.com/san-pham/dong-phuc-pickleball",
    ...
    return {
      props: {
        ...
        meta: {
          title: "Đồng phục Pickleball - Đồng phục Univi",
          description: "Trải nghiệm đồng phục Pickleball Univi cao cấp và BST UniPick sành điệu. Chất liệu chuyên dụng, co giãn tối đa, thoáng khí vượt trội cho mọi chuyển động. Univi mang đến sự thoải mái và phong cách cho người chơi Pickleball. Khám phá ngay!",
          keywords: "đồng phục pickleball, Đồng phục Univi",
          author: "Đồng phục Univi",
